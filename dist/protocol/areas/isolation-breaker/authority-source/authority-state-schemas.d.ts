...
export declare const ISOLATION_AUTHORITY_SOURCE_VERSION_V3: "isolation-authority-source-3";
...
export declare const IsolationAuthoritySourcePayloadV3Schema: z.ZodObject<{
    isolationAuthoritySourceVersion: z.ZodLiteral<"isolation-authority-source-3">;
    scopeDigest: z.ZodString;
    chronologyVersion: z.ZodNumber;
    activeCauses: z.ZodArray<z.ZodObject<{
        causeId: z.ZodString;
        causeDigest: z.ZodString;
        causeRecord: z.ZodObject<{
...
export declare const IsolationAuthoritySourcePayloadAnySchema: z.ZodUnion<readonly [z.ZodObject<{
    isolationAuthoritySourceVersion: z.ZodLiteral<"isolation-authority-source-2">;
    scopeDigest: z.ZodString;
    activeCauses: z.ZodArray<z.ZodObject<{
        causeId: z.ZodString;
...
export type IsolationAuthoritySourcePayloadV3 = Readonly<{
    isolationAuthoritySourceVersion: typeof ISOLATION_AUTHORITY_SOURCE_VERSION_V3;
    scopeDigest: `sha256:${string}`;
    chronologyVersion: number;
    activeCauses: readonly IsolationActiveCauseBinding[];
    activeCauseSetDigest: `sha256:${string}`;
    isolationState: IsolationState;
}>;
export type IsolationAuthoritySourcePayloadAny = IsolationAuthoritySourcePayload | IsolationAuthoritySourcePayloadV3;
