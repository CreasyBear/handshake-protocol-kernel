...
export type KernelTransitionMethod = "putCatalogObject" | "registerInstallProposalCompiledRecords" | "compileIntent" | "commitIngressRefusal" | "createRuntimeExecution" | "createGeneratedExecutionGraph" | "registerGatewayCredentialRef" | "registerDelegatedAuthorityRef" | "transitionDelegatedAuthorityStatus" | "recordGatewayCustodyProofPacket" | "recordCredentialResolutionEvidence" | "recordTypedActionCommitment" | "createBypassProbe" | "createToolCallDraft" | "transitionToolCallDraft" | "createProtectedPathPosture" | "proposeActionContract" | "recordNegotiationSession" | "recordNegotiationOffer" | "recordNegotiationDecision" | "recordLinkedAgreement" | "recordAgreementObligationBinding" | "transitionAgreementStatus" | "createAuthorityCertificate" | "evaluatePolicy" | "createReviewArtifact" | "createReviewDecision" | "gatewayCheck" | "issueAgenticEndpointAccessLease" | "recordAgenticEndpointAccessUsageEvent" | "reconcileSurfaceOperation" | "createIsolationState" | "createBreakerDecision" | "createReceiptExport" | "createRecoveryRecommendation" | "transitionRecoveryRecommendationStatus" | "resolveRecoveryTerminalConflictProofGap";
...
export declare const protocolNavigation: readonly [ProtocolNavigationEntry, ProtocolNavigationEntry, ProtocolNavigationEntry, ProtocolNavigationEntry, {
    ...
    readonly transitionId: "recordTypedActionCommitment";
    readonly kernelMethod: "recordTypedActionCommitment";
    readonly phase: "typed_action_commitment";
    readonly outcomeClasses: readonly ["recorded", "refusal", "proof_gap"];
    readonly recordsWritten: readonly ["typed_action_commitment", "contract_stream_event"];
    readonly eventsEmitted: readonly ["typed_action_commitment_recorded"];
    readonly authorityBoundary: "typed action commitment non-authority evidence only";
    readonly evidenceObligation: "record digest-bound external commitment evidence without creating authority, policy, greenlight, gateway check, mutation, receipt, certificate, endpoint lease, signer custody, payment custody, or downstream-success proof";
}, {
