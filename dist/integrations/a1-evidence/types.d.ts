...
export declare const VECTOR_MISMATCH_PROOF_GAP: "delegation_evidence_verify:vector_mismatch";
export declare const VECTOR_GROUNDTRUTH_UNAVAILABLE_PROOF_GAP: "delegation_evidence_verify:vector_groundtruth_unavailable";
/**
 ...
 */
export declare const SELF_DEFINED_COMPOSITION_PROOF_GAP: "delegation_evidence_verify:self_defined_composition";
