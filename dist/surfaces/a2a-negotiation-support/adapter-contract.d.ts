import { z } from "zod";
import { type A2ANegotiationMovePlan } from "./move-compiler";
export declare const A2ANegotiationSourceProtocolSchema: z.ZodEnum<{
...
export type A2ANegotiationSourceProtocol = z.infer<typeof A2ANegotiationSourceProtocolSchema>;
export declare const A2ANegotiationAdapterAuthorityBoundarySchema: z.ZodObject<{
...
export type A2ANegotiationAdapterAuthorityBoundary = z.infer<typeof A2ANegotiationAdapterAuthorityBoundarySchema>;
export declare const A2ANegotiationAdapterMoveRequestSchema: z.ZodObject<{
    schemaVersion: z.ZodLiteral<"0.2.4">;
    tenantId: z.ZodString;
    organizationId: z.ZodString;
    createdAt: z.ZodString;
    requestKind: z.ZodLiteral<"a2a_negotiation_adapter_move_request">;
...
export type A2ANegotiationAdapterMoveRequest = z.infer<typeof A2ANegotiationAdapterMoveRequestSchema>;
export declare const A2ANegotiationAdapterProtocolWriteSchema: z.ZodDiscriminatedUnion<[z.ZodObject<{
...
export type A2ANegotiationAdapterProtocolWrite = z.infer<typeof A2ANegotiationAdapterProtocolWriteSchema>;
export declare const A2ANegotiationAdapterMoveResultSchema: z.ZodObject<{
    schemaVersion: z.ZodLiteral<"0.2.4">;
    tenantId: z.ZodString;
    organizationId: z.ZodString;
    createdAt: z.ZodString;
...
export type A2ANegotiationAdapterMoveResult = z.infer<typeof A2ANegotiationAdapterMoveResultSchema>;
export declare function compileA2ANegotiationAdapterMove(requestValue: A2ANegotiationAdapterMoveRequest): A2ANegotiationAdapterMoveResult;
export declare function protocolWritesForA2ANegotiationMovePlan(plan: A2ANegotiationMovePlan): A2ANegotiationAdapterProtocolWrite[];
