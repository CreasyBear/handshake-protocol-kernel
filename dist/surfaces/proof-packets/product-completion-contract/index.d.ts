...
export type ProductCompletionGateId = "codex_local_host_activation" | "public_distribution_and_registry" | "customer_gateway_live_x402_paid_proof" | "auth_md_x402_admission_packet" | "customer_edge_cloud_control_plane_source_proof" | "customer_edge_cloud_transport_parity_proof" | "hosted_provider_caller_identity_proof" | "dual_enforcement_posture" | "per_customer_bypass_scaffold";
 ...
 */
export declare const PRODUCT_COMPLETION_GATE_IDS: readonly ["codex_local_host_activation", "public_distribution_and_registry", "customer_gateway_live_x402_paid_proof", "auth_md_x402_admission_packet", "customer_edge_cloud_control_plane_source_proof", "customer_edge_cloud_transport_parity_proof", "hosted_provider_caller_identity_proof", "dual_enforcement_posture", "per_customer_bypass_scaffold"];
