import { z } from "zod";
export declare const HERMES_X402_PROTECTED_TOOL_ACTIVATION_VERSION: "handshake.adapter.x402-protected-tool-hermes-activation.v1";
export declare const HermesX402ProtectedToolActivationInputSchema: z.ZodObject<{
    schemaVersion: z.ZodDefault<z.ZodLiteral<"handshake.adapter.x402-protected-tool-hermes-activation.v1">>;
...
export declare const HermesX402ProtectedToolActivationArtifactSchema: z.ZodObject<{
    schemaVersion: z.ZodLiteral<"handshake.adapter.x402-protected-tool-hermes-activation.v1">;
    activationId: z.ZodString;
    hostFamily: z.ZodLiteral<"hermes">;
    packageIdentifier: z.ZodString;
    packageVersion: z.ZodString;
...
export declare function buildHermesX402ProtectedToolActivation(inputValue: HermesX402ProtectedToolActivationInput): HermesX402ProtectedToolActivationArtifact;
