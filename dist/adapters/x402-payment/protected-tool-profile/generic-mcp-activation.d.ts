import { z } from "zod";
export declare const GENERIC_MCP_X402_PROTECTED_TOOL_ACTIVATION_VERSION: "handshake.adapter.x402-protected-tool-generic-mcp-activation.v1";
export declare const GenericMcpX402ProtectedToolActivationInputSchema: z.ZodObject<{
    schemaVersion: z.ZodDefault<z.ZodLiteral<"handshake.adapter.x402-protected-tool-generic-mcp-activation.v1">>;
...
export type GenericMcpX402ProtectedToolActivationInput = z.input<typeof GenericMcpX402ProtectedToolActivationInputSchema>;
export declare const GenericMcpX402ProtectedToolActivationArtifactSchema: z.ZodObject<{
    schemaVersion: z.ZodLiteral<"handshake.adapter.x402-protected-tool-generic-mcp-activation.v1">;
    activationId: z.ZodString;
    hostFamily: z.ZodLiteral<"generic_mcp">;
    packageIdentifier: z.ZodString;
    packageVersion: z.ZodString;
...
export type GenericMcpX402ProtectedToolActivationArtifact = z.infer<typeof GenericMcpX402ProtectedToolActivationArtifactSchema>;
export declare function buildGenericMcpX402ProtectedToolActivation(inputValue: GenericMcpX402ProtectedToolActivationInput): GenericMcpX402ProtectedToolActivationArtifact;
