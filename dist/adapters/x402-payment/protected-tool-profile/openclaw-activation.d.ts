import { z } from "zod";
export declare const OPENCLAW_X402_PROTECTED_TOOL_ACTIVATION_VERSION: "handshake.adapter.x402-protected-tool-openclaw-activation.v1";
export declare const OpenClawX402ProtectedToolActivationInputSchema: z.ZodObject<{
    schemaVersion: z.ZodDefault<z.ZodLiteral<"handshake.adapter.x402-protected-tool-openclaw-activation.v1">>;
    ...
    toolPacketConfigTarget: z.ZodDefault<z.ZodString>;
    toolPacketName: z.ZodDefault<z.ZodString>;
...
export declare const OpenClawX402ProtectedToolActivationArtifactSchema: z.ZodObject<{
    schemaVersion: z.ZodLiteral<"handshake.adapter.x402-protected-tool-openclaw-activation.v1">;
    activationId: z.ZodString;
    hostFamily: z.ZodLiteral<"openclaw">;
    packageIdentifier: z.ZodString;
    packageVersion: z.ZodString;
    toolName: z.ZodLiteral<"handshake.actions.x402_payment.propose">;
    toolPacketConfigTarget: z.ZodString;
    toolPacketName: z.ZodString;
    command: z.ZodString;
    args: z.ZodArray<z.ZodString>;
...
export type OpenClawX402ProtectedToolActivationArtifact = z.infer<typeof OpenClawX402ProtectedToolActivationArtifactSchema>;
export declare function buildOpenClawX402ProtectedToolActivation(inputValue: OpenClawX402ProtectedToolActivationInput): OpenClawX402ProtectedToolActivationArtifact;
