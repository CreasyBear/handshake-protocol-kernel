import { z } from "zod";
export declare const CLAUDE_CODE_X402_PROTECTED_TOOL_ACTIVATION_VERSION: "handshake.adapter.x402-protected-tool-claude-code-activation.v1";
export declare const ClaudeCodeX402ProtectedToolActivationInputSchema: z.ZodObject<{
    schemaVersion: z.ZodDefault<z.ZodLiteral<"handshake.adapter.x402-protected-tool-claude-code-activation.v1">>;
    ...
    mcpConfigTarget: z.ZodDefault<z.ZodString>;
...
export type ClaudeCodeX402ProtectedToolActivationInput = z.input<typeof ClaudeCodeX402ProtectedToolActivationInputSchema>;
export declare const ClaudeCodeX402ProtectedToolActivationArtifactSchema: z.ZodObject<{
    schemaVersion: z.ZodLiteral<"handshake.adapter.x402-protected-tool-claude-code-activation.v1">;
    activationId: z.ZodString;
    hostFamily: z.ZodLiteral<"claude_code_mcp">;
    packageIdentifier: z.ZodString;
    packageVersion: z.ZodString;
    toolName: z.ZodLiteral<"handshake.actions.x402_payment.propose">;
    mcpConfigTarget: z.ZodString;
...
export type ClaudeCodeX402ProtectedToolActivationArtifact = z.infer<typeof ClaudeCodeX402ProtectedToolActivationArtifactSchema>;
export declare function buildClaudeCodeX402ProtectedToolActivation(inputValue: ClaudeCodeX402ProtectedToolActivationInput): ClaudeCodeX402ProtectedToolActivationArtifact;
