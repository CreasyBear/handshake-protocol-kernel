import { z } from "zod";
import { type ActionType, type GatewayRegistryEntry, type OperatingEnvelope, type ToolCapability } from "../../protocol/areas/catalog-envelope";
export declare const InstallProposalBypassProbePlanItemSchema: z.ZodObject<{
    probeKind: z.ZodEnum<{
...
export declare const InstallProposalCompiledKernelRecordsSchema: z.ZodObject<{
